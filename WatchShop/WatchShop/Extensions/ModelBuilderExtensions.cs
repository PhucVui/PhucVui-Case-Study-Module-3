    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
              ...
              new Product { Name = "Bulova 784", Price = 10000000, Id = 3, CategoryId = 3, CreateAt = DateTime.Today, AvataPath = "Urgot.jpg" },
              ...
              new Product { Name = "Sunrise 246", Price = 10000000, Id = 7, CategoryId = 7, CreateAt = DateTime.Today, AvataPath = "images5.jpg" },
              new Product { Name = "Julius 0012", Price = 4000000, Id = 8, CategoryId = 8, CreateAt = DateTime.Today, AvataPath = "images2.jpg" },
              new Product { Name = "Pianus 564", Price = 10000000, Id = 9, CategoryId = 9, CreateAt = DateTime.Today, AvataPath = "images1.jpg" },
              new Product { Name = "DW Nữ", Price = 11000000, Id = 10, CategoryId = 10, CreateAt = DateTime.Today, AvataPath = "images5.jpg" }
              );
        }
    }
}
